...
Below details the two types of data collected. One being pressure, our primary focus, and the other temperature, for future use. You can read more about our pressure sensor and its I^2C communication using the links included at the bottom of the readme.  
